            ...
            <>
              {rows.length === 0 ? <EmptyState title="No settings yet" /> : (
                <div className="mb-4 flex flex-col gap-2">
                  {rows.map(r => (
                    <div key={r.key} className="grid grid-cols-[1fr_1fr_auto_auto] items-center gap-2 rounded-lg border p-2.5" style={{ borderColor: 'var(--border)' }}>
              ...
              <div className="grid grid-cols-[1fr_1fr_auto] items-center gap-2 border-t pt-4" style={{ borderColor: 'var(--border-soft)' }}>
