...
export default function Violations() {
  ...
  return (
    <div>
      ...
      {loading ? (
        <main className="p-8 pb-24"><Card><Spinner /></Card></main>
      ) : error ? (
        <main className="p-8 pb-24"><Card><LoadError message={error} onRetry={loadAccounts} /></Card></main>
      ) : (
      <main className="grid grid-cols-1 gap-4 p-8 pb-24 lg:grid-cols-2">
        <Card>
